# Use GPT-4.1 to analyze OCLC results and assign confidence scores
import os
import time
import json
import openpyxl
...
from cd_workflow_config import get_model_config, get_file_path_config, get_threshold_config, get_step_config, get_token_limit_param, get_temperature_param, get_openai_client
        ...
        try:
            ...
            if not success:
                ...
                update_workbook_row(sheet, temp_sheet, row, "Not found", 0,
                                  f"FAILED after retries: {error[:200]}", "", 0, 0, 0, 0)
