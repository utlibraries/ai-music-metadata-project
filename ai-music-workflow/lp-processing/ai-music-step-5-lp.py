...
def find_latest_lp_metadata_file(results_folder):
    # Find files starting with "lp-metadata-ai-" and ending with ".xlsx"
...
def create_all_records_spreadsheet():
    ...
    if not step4_file:
        print("No lp-metadata-ai file found in the results folder!")
    ...
    try:
        ...
        try:
            ...
            # Go up 2 levels: lp-processing -> ai-music-workflow -> project root
